...
<template>
  <div class="category">
    ...
    <SlideBar :slide-bar-list="categoryList" @slideBarItemClick="slideBarItemClick" />
    <Scroll class="scroll-height">
      <Subcategory :category-list="subcategoryList" />
      <TabControl ref="tabControl" :titles="titleList" @tabClick="tabClick" />
      <GoodsList :goods="categoryDetailList" :goods-height="false" />
    </Scroll>
  </div>
</template>
